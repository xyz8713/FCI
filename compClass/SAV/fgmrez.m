function [sol,res,its] = fgmrez (A,preClass,precfun,rhs,sol,ARMSopt) 
%-----------complex version---------------------------------------------
%
...
%%arms_params;   %%%%%%%% defines parameters maxits, tol etc. 
  tolIts = ARMSopt.tolIts;
  maxits = ARMSopt.maxits;
  outputG = ARMSopt.outputG;
  im  = ARMSopt.im;
  tolmac = eps;
%%%%
 n = size(A,1)    ;
