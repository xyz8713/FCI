function  A = E3d_ISO( freq, dim, tos, FS, Nx, Ny, Nz, N_delta, sigma0, hx, hy, hz, label, Vp, Vs, rho )
                ...
                for jj = -1:1
                    for ii = -1:1
                        if xx+ii >= 1 && xx+ii <= Nx && yy+jj >= 1 && yy+jj <= Ny && zz+kk >= 1 && zz+kk <= Nz
                            ...
                            C11(ii+2,jj+2,kk+2) = rho(xx+ii,yy+jj,zz+kk) * Vp(xx+ii,yy+jj,zz+kk)^2;
                            C22(ii+2,jj+2,kk+2) = C11(ii+2,jj+2,kk+2);
                            C33(ii+2,jj+2,kk+2) = C11(ii+2,jj+2,kk+2);
                            C44(ii+2,jj+2,kk+2) = rho(xx+ii,yy+jj,zz+kk) * Vs(xx+ii,yy+jj,zz+kk)^2;
                            C55(ii+2,jj+2,kk+2) = C44(ii+2,jj+2,kk+2);
                            C66(ii+2,jj+2,kk+2) = C44(ii+2,jj+2,kk+2);
                            C12(ii+2,jj+2,kk+2) = C11(ii+2,jj+2,kk+2) - 2*C44(ii+2,jj+2,kk+2);
                            C13(ii+2,jj+2,kk+2) = C12(ii+2,jj+2,kk+2);
                            C23(ii+2,jj+2,kk+2) = C12(ii+2,jj+2,kk+2);
                        end
                    end
                end
            end
